...
export const SHOULD_INSIDE_CLICK_NEXT = false;
...
// language=HTML
// <div class="modal tour" role="dialog" aria-modal="true" aria-labelledby="dialog_label" aria-describedby="dialog_desc" aria-hidden="true">
export const POPOVER_HTML = (className = '') => `
  <div id="${ID_POPOVER}" class="${className}" role="dialog" aria-modal="true" aria-labelledby="${ID_POPOVER}-label" aria-describedby="${ID_POPOVER}-desc">
    <div class="${CLASS_POPOVER_TIP}"></div>
    <div id="${ID_POPOVER}-label" class="${CLASS_POPOVER_TITLE}">Popover Title</div>
    <div id="${ID_POPOVER}-desc" class="${CLASS_POPOVER_DESCRIPTION}">Popover Description</div>
